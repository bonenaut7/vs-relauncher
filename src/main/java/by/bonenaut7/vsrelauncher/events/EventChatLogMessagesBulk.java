...
/**
 * @param messages - Chat log read lines
 ...
 */
public final class EventChatLogMessagesBulk extends Event {
	private final List<String> messages;
	private final boolean logInit;
	
	public EventChatLogMessagesBulk(List<String> messages, boolean logInit) {
